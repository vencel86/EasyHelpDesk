Public Class rptViewAll

    Private Sub rptView_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        'TODO: This line of code loads data into the 'AllCalls.tbl_CallGen' table. You can move, or remove it, as needed.
        'Me.Tbl_CallGenTableAdapter1.Fill(Me.AllCalls.tbl_CallGen)
        'TODO: This line of code loads data into the 'AllCalls.tbl_CallGen' table. You can move, or remove it, as needed.
        'Me.Tbl_CallGenTableAdapter1.Fill(Me.AllCalls.tbl_CallGen)
        Try
